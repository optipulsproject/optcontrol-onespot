...
\begin{tikzpicture}[scale=1.2]
	...
	% fillers
	\draw [draw=none, fill=gray!15] (-\varR,0) rectangle (\varR,-\vardi-\vardii);
	...
	\draw [myorange, thick, fill=myorange!35] (-.1,0) ++(180:\varr) arc (180:360:\varr+0.1);
	\draw [myorange, thick, fill=myorange!20] (0,0) ++(180:\varr) arc (180:360:\varr);
	% \draw [decoration={
 %            text along path,
 %            text={liquidus},
 %            text align={right},
 %            raise=-0.2cm}, decorate] (0,0) ++(180:\varr) arc (180:360:\varr);
