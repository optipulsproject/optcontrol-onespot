...
The common problem parameters shared by the numerical experiments presented in this section are provided in \cref{tab:parameters} (see also \cite[\texttt{env/problem.py}]{optcontrol_github}).
