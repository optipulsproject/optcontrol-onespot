...
\begin{figure}[ht]
	\centering
	\input{plots/pgf/vhc.pgf}
	\input{plots/pgf/kappa.pgf}
...
\begin{figure}[h]
	...
	\caption{This is just a proof of concept. Do not take it seriously.}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics{plots/optimized/rampdown.pdf}
	\caption{Yet another dummy plot.}
\end{figure}

\begin{table} \label{tab:report}
	\centering
	\input{reports/table_report}
	\caption{Report on the optimizations...}
\end{table}
